                  ...
                  <div class="card-body card-dashboard">
                      <table class="table table-striped table-bordered zero-configuration">
                        ...
                        <tr>
                          ...
                          <td>
                          	<div class="btn-group">
                          		@if($data->b1 !== NULL || $data->b2 !== NULL || $data->b3 !== NULL || $data->b4 !== NULL || $data->b5 !== NULL || $data->b6 !== NULL || $data->b7 !== NULL ||  $data->b8 !== NULL ||  $data->b9 !== NULL ||  $data->b10 !== NULL ||  $data->b11 !== NULL )
                          		<button type="button" class="btn btn-info mr-1 mb-1">Done</button>
                          		@else
                            <button type="button" class="btn btn-info mr-1 mb-1"><a href="/sbujknew/{{$data->id}}/edit">Action</a></button>
                            @endif
                          </div></td>
                        </tr>
                        @else @endif
